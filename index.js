...
const ignorePackages = ['sdl2-mixer', 'libvorbis', 'libogg', 'gettext', "libwebp", "bzip2", "libflac", "opus", "opusfile", "gperf", "glslang", "libxau", "libxdmcp", "libxml2", "freetype", "icu", "glib", "libpng", "zlib"];
